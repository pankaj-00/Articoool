...
const Blogtiles = () => {
  ...
  return (
    <div
      className={`items-center xl:columns-${minFunction} lg:columns-3 md:columns-2 grid-container `}
    >
      {docs.map((doc) => {
            ...
            <Link to="/post" className="Link">
              ...
              <div className="blogInfo">
                ...
                <span className="blogTime">
                  <Moment date={doc.data().date} format="lll" />
                </span>
              </div>
              <p
                className={`max-h-${numberOfLines} leading-7 overflow-hidden block text-ellipsis break-words blogDescription`}
              >
                {doc.data().content}
              </p>
            </Link>
